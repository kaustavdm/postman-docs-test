...
![auth menu](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-menu.png)
...
![auth menu](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-preview-request.png)
...
![folder auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-add-auth-folder.png)
...
![folder basic auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-folder-edit.png)
...
![select folder basic auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-select-folder-basic.png)
...
![bearer auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-BearerToken.png)
...
![basic auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-Basic.png)
...
![digest\_auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-Digest+copy.png)
...
![oauth1\_auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-OAuth1_0.png)
...
![oauth2\_auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-OAuth2_0.png)
...
![getrequesttokens\_auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-get-access-token.png)
...
![managetokens\_auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-manage-access-token.png)
...
![hawk\_auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-Hawk.png)
...
![aws\_auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-AWS-Signature.png)
...
![ntlm\_auth](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-auth-NTLM.png)
