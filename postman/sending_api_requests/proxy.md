...
![standard request](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/proxy.request.png)
...
![standard web proxy](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/proxy.standard.png)
...
A proxy acts like a go-between to perform various functions. Postman has a [built-in web proxy to capture API requests](/postman/sending_api_requests/capturing_http_requests.md), the [Postman Interceptor to intercept network traffic](/postman/sending_api_requests/interceptor_extension.md), and proxy settings to direct API requests.

### Configuring proxy settings

This article describes how to configure the proxy settings in Postman to direct all requests made in the Postman app to route through a proxy server. This is different from [capturing network traffic](/postman/sending_api_requests/capturing_http_requests.md) with the built-in proxy which allows Postman to intercept network traffic.
...
![settings modal](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/WS-proxy_settings-a.png)
...
![custom proxy](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/custom.proxy2.png)
...
![custom proxy](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/proxy_custom.png)
...
![system proxy](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/system-proxy2.png)
...
![system proxy](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/proxy_system.png)
