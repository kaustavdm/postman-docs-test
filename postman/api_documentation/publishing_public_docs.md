...
# publishing\_public\_docs

Published documentation enables you to share your [public API documentation](https://github.com/kaustavdm/postman-docs-test/tree/b9c2cefa916197b408de633b2ecb1d256acf0a06/docs/postman_for_publishers/public_api_docs/README.md) with the world.
...
From the **Publish Collection** page, you can select a [corresponding environment](https://github.com/kaustavdm/postman-docs-test/tree/b9c2cefa916197b408de633b2ecb1d256acf0a06/docs/postman/api_documentation/environments_and_environment_templates/README.md) and a corresponding collection version to publish the collection. Any references to variables like `{{url}}` in the collection will be replaced with the correct value from the environment.
...
Optionally, you can pick from a list of verified [custom domains](https://github.com/kaustavdm/postman-docs-test/tree/b9c2cefa916197b408de633b2ecb1d256acf0a06/docs/postman/api_documentation/adding_and_verifying_custom_domains/README.md) to host your API documentation. You’ll be able to view documentation on your custom domain, as well as the Postman private documentation page.
...
Postman allows you to customize the appearance of your published documentation pages. Add your [team logo](https://github.com/kaustavdm/postman-docs-test/tree/b9c2cefa916197b408de633b2ecb1d256acf0a06/docs/postman/api_documentation/adding_team_name_and_logo/README.md) and update the color theme to align with your brand.
