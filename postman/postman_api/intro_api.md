...
For ease of use inside Postman, you could store your API key in an [environment variable](https://github.com/kaustavdm/postman-docs-test/tree/b9c2cefa916197b408de633b2ecb1d256acf0a06/docs/postman/environments_and_globals/variables/README.md) called `postman_api_key`. This collection automatically uses this key to make API calls.
