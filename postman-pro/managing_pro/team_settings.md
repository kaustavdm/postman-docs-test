...
You can also access team settings in the app via the "Teams" dropdown menu in the upper right corner. [![Teams](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/teamdropdown+new+with+logo.png)](https://s3.amazonaws.com/postman-static-getpostman-com/postman-docs/teamdropdown+new+with+logo.png)
